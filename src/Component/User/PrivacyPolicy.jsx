      ...
      <section className="py-5">
        <div className="container">
          ...
          <p>
            ...
            about you, products you like, products you intend to buy, or any
            other information provided by your during the use of our website. We
          ...
          <h2 className="mt-3">We collect information in different ways.</h2>
          <p>
            We collect information directly from you. We collect information
            directly from you when you register for a purchase. We also collect
          ...
          <h2 className="mt-3">Use of your personal information</h2>
          <p>
            We use information to contact you: We might use the information you
            provide to contact you for confirmation of a purchase on our website
            or for other promotional purposes.
          </p>
          <p>
            We use information to respond to your requests or questions. We
            might use your information to confirm your registration for a
            purchase or contest.
          </p>
          <p>
          ...
          <p>
            ...
            interesting. Or, for example, if you buy products from us we'll
            enroll you in our newsletter.
          </p>
          <p>
            We use information to send you transactional communications. We
            might send you emails or SMS about your account or a purchase.
          </p>
          <p>We use information as otherwise permitted by law.</p>
          <h2 className="mt-3">Sharing of information with third-parties</h2>
          <p>
          ...
          <p>
            ...
            information with organizers and other parties responsible for
            fulfilling the purchase obligation. The organizers and other parties
            may use the information we give them as described in their privacy
            policies.
          </p>
          <p>
            We will share information with our business partners. This includes
            a third party who provide logistics. Our partners use the
          ...
          <h2 className="mt-3">Third party sites </h2>
          <p>
          ...
          <h2 className="mt-3">Grievance Officer</h2>
          <p>
          ...
          <p>
            This Privacy Policy was last updated on 1.07.2023. From time to time
          ...
          <h2 className="mt-3">Jurisdiction</h2>
          <p>
