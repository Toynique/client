...
export default function Cart() {
  ...
  const checkoutModel = async () => {
    ...
    const productObj = {
      product: productArr, paymentStatus: "pending", totalproductPrice: totalSalePrice,
      totalDiscount,
      userId,
      totalCheckOut,
      offerDiscount,
  ...
  const checkoutHandle = async (address, paymentType) => {
    console.log("checkoutHandle hit");
    if (!address || !paymentType) {
      console.log("all fields are required. address, paymentType ");
      return
    }
